...
| `walk_max`             | 4.16    | Set the maximum walking speed in kilometers per hour. (14 km/h is the maximum speed for egg hatching)    
| `walk_min`             | 2.16    | Set the minimum walking speed in kilometers per hour. (14 km/h is the maximum speed for egg hatching)    |
