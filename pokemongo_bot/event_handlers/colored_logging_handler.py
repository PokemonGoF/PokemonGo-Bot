...
class ColoredLoggingHandler(EventHandler):
    EVENT_COLOR_MAP = {
        ...
        # event names for 'white' still here to remember that these events are
        # already determined its color.
    ...
    def handle_event(self, event, sender, level, formatted_msg, data):
        ...
        if event in ColoredLoggingHandler.CONTINUOUS_EVENT_NAMES and self._last_event == event:
            # Filling with "' ' * terminal_width" in order to completely clear
            # last line
