    ...
    def handle_event(self, event, sender, level, formatted_msg, data):
        ...
        if event == 'catchable_pokemon':
            ...
            if 'pokemon_id' in data:
                ...
                data_string = "%s, %s, %s, %s, %s, %s" % (str(data['latitude']), str(data['longitude']), str(data['encounter_id']), str(data['pokemon_id']), str(data['expiration_timestamp_ms']), str(data['pokemon_name']))
