...
class GithubPlugin(object):
    ...
    def get_local_destination(self):
        ...
        file_name = '{}_{}_{}.zip'.format(
            parts['user'], parts['repo'], parts['sha'])
    ...
    def get_plugin_folder(self):
        folder_name = '{}_{}'.format(
            self.plugin_parts['user'],
            self.plugin_parts['repo'])
    ...
    def extract(self):
        ...
        github_folder = os.path.join(
            dest, '{}-{}'.format(self.plugin_parts['repo'], self.plugin_parts['sha']))
