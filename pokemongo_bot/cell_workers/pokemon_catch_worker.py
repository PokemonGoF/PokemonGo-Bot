                ...
                if self.response_status_key in response_dict['responses'][self.response_key]:
                    if response_dict['responses'][self.response_key][self.response_status_key] is 1:
                        ...
                        if self.check_vip_pokemon(pokemon_name, cp, pokemon_potential):
                            logger.log('[-] {} is a VIP Pokemon! Nice! Try our best to catch it!'.format(pokemon_name, cp, pokemon_potential),'green')
                            flag_VIP=True
                            ...
                            if response_dict and \
                                ...
                                if status is 3:
                                    logger.log(
                                        ...
                                        iv_display,
                                        pokemon_potential,
                                        str(used_pokeballs) + " " + self.item_list[str(pokeball)] + ("s" if used_pokeballs > 1 else "") + (" and a berry" if berry_used else ""),
                                        str(self.pokemon['latitude']) + "," + str(self.pokemon['longitude'])
                                    ), 'red')
                                ...
                                if status is 1:
                                    ...
                                    logger.log('Captured {}! [{} CP - {} - {}%] [{}] [+{} exp] [{}]'.format(
                                        pokemon_name,
                                        cp,
                                        iv_display,
                                        pokemon_potential,
                                    ...
                                    if (self.config.evolve_captured
                                        ...
                                        if status == 1:
                                            logger.log(
                                                '{} has been evolved!'.format(pokemon_name), 'white')
                                        else:
                                            logger.log(
