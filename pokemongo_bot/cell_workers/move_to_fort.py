...
class MoveToFort(BaseTask):
    ...
    def should_run(self):
        ...
        if not has_space_for_loot:
            logger.yellow("Not moving to any forts as there aren't enough space. You might want to change your config to recycle more items if this message appears consistently.")
